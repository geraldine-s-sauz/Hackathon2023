...
namespace HackathonWebAPI.Helpers
{
    class BinaryAudioStreamReader : PullAudioInputStreamCallback
    {
        ...
        public static PullAudioInputStreamCallback OpenWavFileStream(string filename, out AudioStreamFormat format)
        {
            ...
            if (!foundDataChunk)
            {
                throw new ApplicationException("${filename} does not contain a data chunk!");
            }
