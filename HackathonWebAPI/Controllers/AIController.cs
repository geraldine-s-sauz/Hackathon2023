...
namespace HackathonWebAPI.Controllers
{
    ...
    public class OpenAIController : ControllerBase
    {
        ...
        // This is an API call to OpenAI given a question and answer from user
        [HttpGet("GetPrompt")]
        ...
        //This is an API call to OpenAI given a pre-defined transcribed text and a question from user
